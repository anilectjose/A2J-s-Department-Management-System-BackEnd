...
echo "INSERT INTO `teacher_db`(`name`, `mobile`, `email`, `specification`, `gender`, `qualification`,`photo`) VALUES ('$name','$no','$mail','$speci','$gender','$new_qual','$filename')";
$query=mysqli_query($con,"INSERT INTO `teacher_db`(`name`, `mobile`, `teacher_id`, `email`, `specification`, `gender`, `qualification`,`photo`) VALUES ('$name','$no','$teaid','$mail','$speci','$gender','$new_qual','$filename')");


 #temporary file name to store file
    $tname = $_FILES['file']['tmp_name'];
    #upload directory path
  $uploads_dir = "img/".$filename;
...
<form name="RegForm" method="POST" enctype="multipart/form-data" autocomplete="off">
<b><center><h2>creating new form<h2></center></b>
Teacher ID:
<input type="text" name="tid" id="ti" placeholder="enter your ID" onkeyup="allLetter(document.RegForm.tid)" onkeypress="clearmsg('sp1')"><span id="sp1" style="color:#F00"></span><br>
<br>Name:
<input type="text" name="name" id="nm" placeholder="Name" maxlength=10 onkeyup="clearmsg('sp2')"><span id="sp2" style="color:#F00"></span>
<br><br>
Mobile:
<input type="textarea" id="phn" value="" name="phone"><span id="sp2" style="color:#F00"></span><br><br>
E-mail:
